...
class Transformer(nn.Module):
    def __init__(self, encoder : Encoder , decoder : Decoder , src_embed : InputEmbeddings , tgt_embed : InputEmbeddings , src_pos : PosititonalEncoding , tgt_pos : PosititonalEncoding , projection_layer : ProjectionLayer):
        super().__init__()
...
def build_transformer(src_vocab_size : int , tgt_vocab_size : int , src_seq_len : int , tgt_seq_len , d_model : int = 512 , N : int = 6 , h : int = 8 , dropout : float = 0.1 , d_ff : int = 2048):
    src_embed = InputEmbeddings(d_model , src_vocab_size)
    tgt_embed = InputEmbeddings(d_model , tgt_vocab_size)

    src_pos = PosititonalEncoding(d_model , src_seq_len , dropout)
    tgt_pos = PosititonalEncoding(d_model , tgt_seq_len , dropout)
